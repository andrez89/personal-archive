...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/<?= BASE_PATH ?>activities">List</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="capoeira-songs">Capoeira</a>
                <a class="collapse-item" href="ukulele-songs">Ukulele</a>
    ...
    <!-- Nav Item -->
    <li class="nav-item">
        <a class="nav-link" href="/<?= BASE_PATH ?>stories">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item form-inline h3">
                    <span><?= isset($page) ? $page : "Home" ?></span>
                </li>
            </ul>
